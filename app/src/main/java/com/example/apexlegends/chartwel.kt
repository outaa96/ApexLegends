...
class chartwel : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_chartwel)
        //วิดีโอ
        ...
        videoView.setVideoURI(Uri.parse("android.resource://" + packageName + "/" + R.raw.videochartwel))
