...
class charsevent : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_charsevent)
        //วิดีโอ
        ...
        videoView.setVideoURI(Uri.parse("android.resource://" + packageName + "/" + R.raw.videosevent))
